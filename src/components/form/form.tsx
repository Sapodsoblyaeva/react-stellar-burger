...
export const Form = (props: Props) => {
  ...
  const onLoginClick = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    dispatch(login({ email: emailValue, pass: passValue }))
  }

  const onRegisterClick = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    dispatch(register({ email: emailValue, pass: passValue, name: inputValue }))
  }
  ...
  const onResetClick = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    successResetPassword(passValue).catch((err) => console.log(err))
  }
